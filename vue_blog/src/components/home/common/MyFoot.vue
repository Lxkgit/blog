...
<!--         :style="{background:'url(../../assets/img/footer02.png) no-repeat 50%'}">-->
    </div>
    <div class="fcontainer">
      <p>
        博客已稳定运行<span v-html='longTime'></span><span class="timeJump">(●'◡'●)ﾉ♥</span>
      </p>
      <p>
        <span>Made with</span> <img class="fheart" src="../../../assets/img/heart02.png" alt="heart"/> <span>by GS0.</span>
      </p>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    runTime () { // 运行倒计时
      var _this = this
      var oldTime = new Date('2021/07/15 00:00:00')
      setInterval(function () {
        ...
        _this.longTime = days + '天' + hours + '小时' + minutes + '分' + seconds + '秒'
      }, 1000)
    }
  }
}

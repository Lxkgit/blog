        ...
        <div class="sidebar-header">
          ...
          <div class="search-form">
            <div class="ui small fluid icon input">
              <input v-model="filterText" type="text" placeholder="请输入搜索关键词..."><font-awesome-icon icon="search" />
            </div>
          </div>
        </div>
...
<!--              </a>-->
          ...
          <div class="content-div">
            <div class="article-body markdown-body" v-html="docContent.content_html" />
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    click (choose) {
      // 修改顶部的url（这个修改不会刷新页面）
      // window.history.pushState({ id: 1, name: 'doc' }, '测试', '/doc/' + choose.value)
